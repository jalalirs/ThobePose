...
maya_file_to_open = "../scenes/Hamed_4colors.mb"
...
cmds.file(maya_file_to_open, force=True, open=True)
...
thobeDiscription = {"thobe":(THOBE_FACES,THOBE_SHADER)}
...
def main():
    ...
    for i,d in enumerate(RENDER_DRESSES):
        ...
        make_dir(dressDir)
        render(start+i%3,end,thobe=d,prefix=dressDir)
        hideshow(d,0)
